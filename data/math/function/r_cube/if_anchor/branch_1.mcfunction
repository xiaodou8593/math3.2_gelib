#math:r_cube/if_anchor/branch_1
# math:r_cube/if_anchor_iter调用

scoreboard players operation sstemp_center int = sstemp_x int
scoreboard players operation sstemp_center int += a int

scoreboard players operation sstemp_delta int = uvec_x int
scoreboard players operation sstemp_delta int *= uvec_x int
scoreboard players operation sstemp_delta int /= 10000 int
scoreboard players operation sstemp_a int += sstemp_delta int

execute store result score sstemp_delta int run compute default float math:r_cube/_calc_2ux_center
